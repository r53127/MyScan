...
class ExamPaper():
    ...
    def checkAnswer(self, answers):
        print('进行答案比对')
        cv.imshow("ox_1", self.ox_sheet)
        # 按坐标从上到下排序
        questionCnts = contours.sort_contours(answers, method="top-to-bottom")[0]
