...
class Ui_TabWidget(object):
    def setupUi(self, TabWidget):
        ...
        self.widget.setGeometry(QtCore.QRect(51, 31, 243, 374))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(120, 40, 116, 65))
    ...
    def retranslateUi(self, TabWidget):
        ...
        self.label_6.setText(_translate("TabWidget", "第三步：1、选择考试时间（作为阅卷保存和生成报表的依据）"))
        ...
        self.label_2.setText(_translate("TabWidget", "第四步：生成报表"))
