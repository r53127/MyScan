...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(403, 256)
        Dialog.setSizeGripEnabled(True)
        self.label_1 = QtWidgets.QLabel(Dialog)
        self.label_1.setGeometry(QtCore.QRect(32, 60, 181, 51))
        self.label_1.setObjectName("label_1")
        self.doubleSpinBox = QtWidgets.QDoubleSpinBox(Dialog)
        self.doubleSpinBox.setGeometry(QtCore.QRect(220, 60, 101, 41))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(210, 160, 111, 41))
