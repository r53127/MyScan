...
# Form implementation generated from reading ui file 'E:\MyScan\pic version1.0\PicMainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_3.setGeometry(QtCore.QRect(0, 550, 321, 20))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(30, 210, 251, 341))
        ...
        self.widget.setGeometry(QtCore.QRect(30, 581, 251, 278))
        ...
        self.pushButton_saveas = QtWidgets.QPushButton(self.widget)
        self.pushButton_saveas.setObjectName("pushButton_saveas")
        self.verticalLayout_2.addWidget(self.pushButton_saveas)
        self.pushButton_savebigdata = QtWidgets.QPushButton(self.widget)
        self.pushButton_savebigdata.setObjectName("pushButton_savebigdata")
        self.verticalLayout_2.addWidget(self.pushButton_savebigdata)
        self.line.raise_()
        self.line_2.raise_()
        self.line_3.raise_()
        self.line_4.raise_()
        ...
        self.pushButton_savebigdata.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "导入学生库（首次即可）"))
        ...
        self.label_6.setText(_translate("MainWindow", "考试场次："))
        ...
        self.pushButton_3.setText(_translate("MainWindow", "单张阅卡"))
        self.pushButton_4.setText(_translate("MainWindow", "批量阅卡"))
        ...
        self.pushButton_savebigdata.setText(_translate("MainWindow", "生成大数据文件"))
